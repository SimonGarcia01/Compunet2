...
public class UserWorkoutProgram {
    ...
    private List<GeneralProgress> generalProgressList;

    public List<GeneralProgress> getGeneralProgressList() {
        return generalProgressList;
    }

    public void setGeneralProgressList(List<GeneralProgress> generalProgressList) {
        this.generalProgressList = generalProgressList;
    }
