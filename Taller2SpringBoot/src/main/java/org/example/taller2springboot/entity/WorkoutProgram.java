...
public class WorkoutProgram {
    ...
    private boolean createByTrainer;
    @Column(nullable = false)
    ...
    public WorkoutProgram(Integer workoutId, String name, String description, String photoUrl, boolean createByTrainer, LocalDate creationDate, boolean completed) {
        this.workoutId = workoutId;
        this.name = name;
        this.description = description;
        this.photoUrl = photoUrl;
        this.createByTrainer = createByTrainer;
    ...
    public boolean isCreateByTrainer() {
        return createByTrainer;
    }

    public void setCreateByTrainer(boolean createByTrainer) {
        this.createByTrainer = createByTrainer;
    }
